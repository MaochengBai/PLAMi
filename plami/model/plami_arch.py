...
from plami.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN


class PLAMiMetaModel:

    def __init__(self, config):
        super(PLAMiMetaModel, self).__init__(config)
...
class PLAMiMetaForCausalLM(ABC):
    def __init__(self):
        super(PLAMiMetaForCausalLM, self).__init__()
